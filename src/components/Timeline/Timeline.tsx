        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700">                  
            ...
            <li className="ml-6"> 
                ...
                <Slide duration={500} direction='right'>
                    ...
                    <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-white"> {language === 'en' ? datalang.datalang.en.timeline.henry.from : datalang.datalang.es.timeline.henry.from} </time>
                    <p className="text-base font-normal text-gray-500 dark:text-white"> {language === 'en' ? datalang.datalang.en.timeline.henry.description : datalang.datalang.es.timeline.henry.description} </p>
                </Slide>
            </li>
            <li className="ml-6">
                <Fade cascade duration={1500} damping={1}>
                    <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                        <i className="fas fa-hourglass-start mx-auto experience-icon dark:text-blue-300 "></i>
                    </span>
                </Fade>
            </li>
        </ol>
